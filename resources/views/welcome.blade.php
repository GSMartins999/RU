...
<body class="antialiased">
    <div class="relative flex flex-col items-center justify-center  px-6 min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
        <div class="fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <a href="{{route('admin.login')}}"class="ml-4 text-sm text-white dark:text-white underline">Administrador</a>
            @endif
            @endauth
        </div>
        @endif
